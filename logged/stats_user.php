...
<?php
	...
	echo '<h1>Minhas Estatísticas</h1>

		<h4>Meus status, como usuário</h4>
		<ul>
		...
		<h4 title="Estatísticas acumuladas de seus livros">Meus status, como autor<a id="question" title="Estatísticas acumuladas de seus livros">?</a></h4>
		<ul>

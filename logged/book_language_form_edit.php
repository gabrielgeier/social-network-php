...
<div class= "window" id="small" style="margin-top: 80px;">
	...
	<p id="center2">Adicionar outro Idioma</p> ';
     ...
     echo "<form action='../back-end/book_files_edit.php?bookId=". $bookId."' method='POST' enctype='multipart/form-data'>"; 
	    echo '<select name="language"  id="center" title="Você poderá adicionar outros idiomas depois" required>';
		  
		  	include_once('../back-end/language_select.php');
		  
		echo '</select> 
	<div class="book-upload">
		<label id="book" for="file" style="margin-bottom: 10px;">Procurar Arquivo PDF</label>

...
<script type="text/javascript" src="../js/ranking_languages.js"></script>
...
<section>
  <h1>Ranking de Idiomas</h1>
  <div class="table-window-languages">
  	<form id="form" action="../back-end/ranking_languages_show.php" method="POST">
  		<p>
  			<div id="methods">
  			<p>Filtro: 

...
<script type="text/javascript" src="../js/ranking_genres.js"></script>
...
<section>
  <h1>Ranking de Gêneros Literários</h1>
  <div class="table-window-genres">
  	<form id="form" action="../back-end/ranking_genres_show.php" method="POST">
  		<p>
  			<div id="methods">
  			<p>Filtro: 

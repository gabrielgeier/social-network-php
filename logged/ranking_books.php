...
<?php
 echo '<script type="text/javascript" src="../js/ranking_books.js?'.mt_rand().'"></script>';

 echo'<link rel="stylesheet" type="text/css" href="../css/ranking.css?'.mt_rand().'">'; 
...
<section>
  ...
  <div class="table-window-book">
  	<form id="form" action="../back-end/ranking_books_show.php" method="POST">
  		<p>
  			<div id="methods">
  			<p>Filtro: 
	  		...
	  		<p>Ordenar:
	  			<select name="order" id="order" required>
	  				<option value="book">Título</option>
